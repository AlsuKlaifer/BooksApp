...
struct MockData {
    ...
    private let category: ListSection = {
        .category([
            .init(title: "Book 1", author: "Author 1", image: "book.closed"),
            .init(title: "Book 2", author: "Author 2", image: "book.closed"),
            .init(title: "Book 3", author: "Author 3", image: "book.closed"),
            .init(title: "Book 4", author: "Author 4", image: "book.closed"),
            .init(title: "Book 5", author: "Author 5", image: "book.closed"),
        ])
    }()
